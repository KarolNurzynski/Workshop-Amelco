...
CREATE TABLE `bet_offer` (
  ...
  `published` datetime DEFAULT NULL,
  `bet_offer_type_id` bigint(20) DEFAULT NULL,
  `event_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKl2mdtuhngvjpt95httq0mxp4d` (`bet_offer_type_id`),
  KEY `FKg7xbwqpsaf20ossn5mgunmj3s` (`event_id`)
...
INSERT INTO `bet_offer` VALUES (1,NULL,'Event1 - Team1 wins',2.70,'2018-05-31 20:20:00',1,1),(2,NULL,'Event1 - Team2 wins',1.50,'2018-05-31 20:20:00',2,1),(3,NULL,'Event1 - Team1 - T1:T2 2:0',3.50,'2018-05-31 20:20:00',3,1),(4,NULL,'Event1 - Team1 - T1:T2 1:0',2.10,'2018-05-31 20:20:00',4,1),(5,NULL,'Event1 - Team1 wins',3.00,'2018-05-28 20:20:00',1,1);
/*!40000 ALTER TABLE `bet_offer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bet_offer_type`
--

DROP TABLE IF EXISTS `bet_offer_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bet_offer_type` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `event_group_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKmcueajtxcc8ah3ctx636qwepu` (`event_group_id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `bet_offer_type`
--

LOCK TABLES `bet_offer_type` WRITE;
/*!40000 ALTER TABLE `bet_offer_type` DISABLE KEYS */;
INSERT INTO `bet_offer_type` VALUES (1,'team1Wins',1),(2,'team2Wins',1),(3,'T1:T2 2:0',1),(4,'T1:T2 1:0',1),(5,'team1Wins',2),(6,'team2Wins',2),(7,'T1:T2 3:2',2),(8,'T2:T1 3:2',2),(9,'team1Wins',3),(10,'team2Wins',3),(11,'team3Wins',3),(13,'team1 - first or second',3);
/*!40000 ALTER TABLE `bet_offer_type` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `event` (
  ...
  KEY `FKc8cgley7pk5m18kmxbcxw86vq` (`event_group_id`)
...
INSERT INTO `event` VALUES (1,'2018-06-10 20:00:00','A Polish football league 1 game example',1,1,1,NULL,NULL),(2,'2018-06-11 20:00:00','Tennis worldcup1 game example',4,2,2,NULL,NULL),(3,'2018-06-12 20:00:00','Horse race worldcup1 example',8,2,3,NULL,NULL);
...
INSERT INTO `event_group` VALUES (1,'football'),(2,'tennis'),(3,'horseracing');
...
-- Dump completed on 2018-05-31 23:00:00
