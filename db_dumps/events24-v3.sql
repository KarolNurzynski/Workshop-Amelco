...
CREATE TABLE `bet_offer` (
  ...
  `bet_offer_status` int(11) DEFAULT NULL,
  `finished` datetime DEFAULT NULL,
  `published` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `event_details_bet_offer_types`
--

DROP TABLE IF EXISTS `event_details_bet_offer_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `event_details_bet_offer_types` (
  `event_detail_id` bigint(20) NOT NULL,
  `bet_offer_types_id` bigint(20) NOT NULL,
  KEY `FK57ekgau99flrt8n07kc8slbea` (`bet_offer_types_id`),
  KEY `FKabqmwckqyg8xbw9l82tm35p8g` (`event_detail_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `event_details_bet_offer_types`
--

LOCK TABLES `event_details_bet_offer_types` WRITE;
/*!40000 ALTER TABLE `event_details_bet_offer_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `event_details_bet_offer_types` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user` (
  ...
  `event_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKpjvjluuwu3vtpeesac7j2ooq8` (`event_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-05-31 14:20:56
